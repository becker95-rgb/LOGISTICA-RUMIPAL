...
async function startServer() {
  ...
  app.get("/api/fetch-sheet", async (req, res) => {
    try {
      ...
      // Return the raw TSV so frontend can parse it and handle UI matching elegantly, or keep it light and handle errors
      return res.json({ tsv: tsvText, sheetId, gid });
    } catch (error: any) {
